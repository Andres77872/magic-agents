...
One page per current built-in node type. This section is the detailed reference layer; the shorter wiki-level index is [../wiki/NODE_REFERENCE.md](../wiki/NODE_REFERENCE.md).
